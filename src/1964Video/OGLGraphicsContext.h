...
class CGLTextureBuffer : public CTextureBuffer
{
	// Haven't implemented yet
public:
	CGLTextureBuffer(int width, int height, TextureBufferInfo* pInfo, TextureUsage usage) 
		: CTextureBuffer(width,height,pInfo, usage) {}

	bool SetAsRenderTarget(bool enable) {return false;}
